...
def database_connection():
    ...
    client = MongoClient("mongodb+srv://jaynaspikes53:STOHwWSzeeZjgVMk@craverank-1.dq9ic.mongodb.net/CraveRank_Restaurants?retryWrites=true&w=majority&socketTimeoutMS=60000&connectTimeoutMS=60000")
...
def search_restaurants():
    ...
    try:
        ...
        # Log the exception and traceback for detailed error information
